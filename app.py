...
def health_check():
    ...
    model_status = artifact_status(artifacts) if models_loaded else {}
    ...
    return {
        ...
        "available_models": [
            "GRU4Rec",
            "Item-CF" if model_status.get("item_cf_loaded") else "Item-CF optional",
            "PopularityFallback",
        ],
        "deployment_mode": "full_local_hybrid",
